...
import { verb_types, verb_questions, noun_questions, all_questions, tenses, non_passive_tenses, cases } from "../grammar/vocab"
...
export async function generate_question(quiz_id, answer_type, question_type){
    ...
    if (this_q_type == "Tenses"){
        const tense = non_passive_tenses[Math.floor(Math.random()*non_passive_tenses.length)];
