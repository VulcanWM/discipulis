...
const metadata = {
  ...
  "All Nouns": {Description: "View all the nouns you need to learn to be proficient in Latin",
  ...
  "All Verbs": {Description: "View all the verbs you need to learn to be proficient in Latin",
  ...
  "Browse Sets": {Description: "View all the sets you can be tested in and how many plays they each have",
  ...
  "Convert Noun": {Description: "Convert any english noun in the wordlist to a Latin case and number",
  ...
  "Convert Verb": {Description: "Convert any english verb in the wordlist to a Latin number, tense and person",
  ...
  "ChangeLog": {Description: "View the Discipulis ChangeLog to see when each feature was added", 
  Tags: "discipulis,verbs,nouns,convert,students,latin,fun,gcse,student,puella,mensa,amo,ocr,puer,school,moneo,vulcanwm"}        
}
